  ...
  return (
    <div className="w-full h-72 bg-gray-300 rounded-lg overflow-hidden grid grid-rows-[40px_1fr]">
      <div className="w-full bg-gray-500 px-4 flex items-center justify-between">
        <span className="text-white">First Modal</span>
      ...
      <div className="flex items-center justify-center">
        ...
        >
          <div className="sm:max-w-[400px] sm:max-h-[300px] sm:h-[200px] sm:w-[400px] px-4 py-4 flex flex-col bg-white rounded-lg w-[calc(100%-10%)] min-h-[200px]">
